        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-[0_2px_20px_rgba(0,0,0,0.06)]">
            ...
            {[
              ...
              { param: "מוטיבציה", regular: "נמוכה | \"שיהיה…\"", spify: "גבוהה מאוד | \"אני חייב את זה\"" },
              { param: "התנהגות עובדים", regular: "אין שינוי אמיתי", spify: "מתחילים לדבר על זה | משווים | נכנסים לתחרות" },
              { param: "תפעול למנהל", regular: "אקסל, ספקים, כאב ראש", spify: "הכל מנוהל עבורך | ללא התעסקות" },
              { param: "חוויה אחרי", regular: "נשכח אחרי יום", spify: "נשאר בבית / בזיכרון | ממשיך לעבוד בשביל הבא" },
            ].map((row, i) => (
